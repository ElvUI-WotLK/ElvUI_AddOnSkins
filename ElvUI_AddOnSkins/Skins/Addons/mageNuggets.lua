...
local function LoadSkin()
	...
	for _, frame in pairs(procFrames) do
		...
		_G[frame .. "Text"]:FontTemplate();
		_G[frame .. "Text2"]:FontTemplate(nil, 10);
	...
	local hordeButtons = {"PortDal", "PortShat", "PortOrg", "PortUC", "PortTB", "PortSMC", "PortStonard", "TeleDal", "TeleShat", "TeleOrg", "TeleUC", "TeleTB", "TeleSMC", "TeleStonard", "Hearth"};
	...
	local alliButtons = {"PortDal", "PortShat", "PortIF", "PortSW", "PortDarn", "PortExo", "PortTheramore", "TeleDal", "TeleShat", "TeleIF", "TeleSW", "TeleDarn", "TeleExo", "TeleTheramore", "Hearth"};
